...
\newcommand{\prob}[1]{{\color{RoyalBlue}\textbf{{{\ifthenelse{\equal{#1}{}}{\textit{Problem:}}{\textit{Problem} {\large \textcolor{Black}{#1}}\textsf{:}}}}}}}
\newcommand{\soln}[1]{{\color{BrickRed}\textbf{{{\ifthenelse{\equal{#1}{}}{{\textit{Solution:}}}{{\textit{Solution}} {\large \textcolor{Black}{#1}}\textsf{:}}}}}}}
