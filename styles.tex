...
\usepackage{float, wrapfig, picinpar, siunitx}
\usepackage{lastpage, hyperref, textcomp}
\usepackage{url, interval, calc,framed, fancybox, quoting, empheq, algorithm, stackrel, sectsty}
...
\usetikzlibrary{shapes,calendar,matrix,backgrounds,folding,knots,decorations.markings,calc,arrows,petri,topaths,fadings,decorations.pathreplacing}
...
\newcommand{\parte}[1]{\vspace{2\parskip}\noindent{\color{Cerulean}\textbf{{{\ifthenelse{\equal{#1}{}}{{Part:}}{{Part} {\textcolor{Black}{#1}}{.}}}}}}}
\newcommand{\prob}[1]{\vspace{2\parskip}\noindent{\color{BrickRed}\textbf{{{\ifthenelse{\equal{#1}{}}{{Problem:}}{{Problem} {\large\textcolor{Black}{#1}}{.}}}}}} \stepcounter{probCounter}}
\newcommand{\soln}[1]{\noindent{\textbf{{{\ifthenelse{\equal{#1}{}}{{{Solution:}}}{{{Solution}} {\large \textcolor{Black}{#1}}{.}}}}}}}
