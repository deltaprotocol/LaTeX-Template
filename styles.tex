...
\usepackage{url,interval,calc,framed,fancybox,quoting,empheq,algorithm}
...
\newcommand{\prob}[1]{\noindent{\color{RoyalBlue}\textbf{{{\ifthenelse{\equal{#1}{}}{{Problem:}}{{Problem} {\large \textcolor{Black}{#1}}\textsf{:}}}}}} \addtocounter{probCounter}{1}}
