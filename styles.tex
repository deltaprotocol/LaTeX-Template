...
\usetikzlibrary{shapes,calendar,matrix,backgrounds,folding,knots,decorations.markings,calc,arrows,petri,topaths}
...
wpoint/.style={circle, inner sep=0pt, minimum size=2pt, fill=white, draw=black},%
bpoint/.style={circle, inner sep=0pt, minimum size=2pt, fill=black, draw=black},%
}
